...
<article id="post-<?php the_ID(); ?>" <?php $this->classes( 'article' ); ?>>
	<header <?php $this->classes( 'entry-header' ); ?>>
		<h1 <?php $this->classes( '* entry-title' ); ?>><a class="entry_title_a" style="color:#222222;text-decoration:none;" href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'twentyeleven' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
