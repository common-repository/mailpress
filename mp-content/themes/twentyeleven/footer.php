...
?>
						<div  <?php $this->classes( '* site-generator' ); ?>>
							<a style="color: #555;font-weight: bold;" href="<?php echo esc_url( 'http://blog.mailpress.org/' ); ?>" title="<?php echo esc_attr( __( 'The WordPress Mailing Plugin' ) ); ?>"><?php printf( 'Proudly mailed by %s', 'MailPress' ); ?></a>
						</div>
					</footer><!-- #colophon -->
				</div><!-- #page -->
