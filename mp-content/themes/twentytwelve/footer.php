...
<?php //$this->get_sidebar(); ?>
				...
				<footer <?php $this->classes( '* cb colophon' ); ?> role="contentinfo">
					<div <?php $this->classes( '* cb' ); ?>>
						<a <?php $this->classes( '* cb site-info_a' ); ?> href="<?php echo esc_url( 'http://blog.mailpress.org/' ); ?>" title="<?php echo esc_attr( __( 'The WordPress Mailing Plugin' ) ); ?>"><?php printf( 'Proudly mailed by %s', 'MailPress' ); ?></a>
					</div>
				</footer><!-- #colophon -->
			</div><!-- #page -->
