...
<div id="mpdraft-adder" class="wp-hidden-children">
	<h4>
		<a id="mpdraft-add-toggle" class="hide-if-no-js" href="#mpdraft-add"><?php _e( '+ Add New Draft', 'MailPress' ); ?></a> 
	</h4>
	<p id="mpdraft-add" class="wp-hidden-child">
		<select name="newmpdraft" id="newmpdraft" style="width:100%;font-size:11px;height:2em;padding:2px;">
<?php
...
?>
		...
		<input type="button" id="mpdraft-add-submit" class="add:mpdraftchecklist:mpdraft-add button" data-wp-lists="add:mpdraftchecklist:mpdraft-add button" value="<?php echo esc_attr( __( 'Add', 'MailPress' ) ); ?>" tabindex="3" />
